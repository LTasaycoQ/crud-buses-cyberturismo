					...
					<div class="panel-heading">
							<div class="row"
								...
								<div class="col-md-3 col-sm-3 col-xs-3">
									...
									<div class="col-md-2 col-sm-2 col-xs-2" id="Buscar" style="position: relative;left: 180px; display:flex; margin-right: 60px;gap:30px; top: 10px;">
										<br>
										...
										<button type="button" class="btn btn-warning"
											id="btnBuscar" style="width: auto; "
											name="btnBuscar">Listar</button>
